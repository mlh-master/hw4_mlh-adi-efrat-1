...
model_relu.add(Dense(300, input_shape=(1024,), activation='relu', kernel_initializer='he_normal'))
...
loss_and_acc_relu = model_relu.evaluate(X_test, Y_test, verbose=2)

print("Test Loss is {:.2f}".format(loss_and_acc_relu[0]))
print("Test Accuracy is {:.2f}%".format(100*loss_and_acc_relu[1]))
#----------------------------------------------------------------------------------------
...
new_a_model.add(Dense(300, input_shape=(1024,), kernel_initializer='he_normal'))
...
save_dir = "results/"
model_name = "init_weights_new_a_model.h5"
model_path = os.path.join(save_dir, model_name)
new_a_model.save(model_path)

history_new_a_25 = new_a_model.fit(BaseX_train, BaseY_train,
                                   batch_size=batch_size, epochs=epochs,
                                   verbose=2, validation_data=(BaseX_val, BaseY_val))

loss_and_acc_new_a_25 = new_a_model.evaluate(X_test, Y_test, verbose=2)

print("Test Loss is {:.2f}".format(loss_and_acc_new_a_25[0]))
print("Test Accuracy is {:.2f}%".format(100*loss_and_acc_new_a_25[1]))
#-----------------------------------------------------------------------------------------
...
#--------------------------Implement your code here:-------------------------------------
new_a_model_40 = load_model("results/init_weights_new_a_model.h5")

history_new_a_40 = new_a_model_40.fit(BaseX_train, BaseY_train,
                                      batch_size=batch_size, epochs=epochs,
                                      verbose=2, validation_data=(BaseX_val, BaseY_val))

loss_and_acc_new_a_40 = new_a_model_40.evaluate(X_test, Y_test, verbose=2)

print("Test Loss is {:.2f} ".format(loss_and_acc_new_a_40[0]))
print("Test Accuracy is {:.2f} %".format(100*loss_and_acc_new_a_40[1]))
#-----------------------------------------------------------------------------------------
...
history_2 = model_relu.fit(BaseX_train, BaseY_train,
                           batch_size=batch_size, epochs=epochs,
                           verbose=2, validation_data=(BaseX_val, BaseY_val))


loss_and_acc_relu_32 = model_relu.evaluate(X_test, Y_test, verbose=2)

print("Test Loss is {:.2f}".format(loss_and_acc_relu_32[0]))
print("Test Accuracy is {:.2f}%".format(100*loss_and_acc_relu_32[1]))
#----------------------------------------------------------------------------------------
...
history_new_a_32 = new_a_model.fit(BaseX_train, BaseY_train,
                                   batch_size=batch_size, epochs=epochs,
                                   verbose=2, validation_data=(BaseX_val, BaseY_val))

loss_and_acc_new_a_32 = new_a_model.evaluate(X_test, Y_test, verbose=2)

print("Test Loss is {:.2f} ".format(loss_and_acc_new_a_32[0]))
print("Test Accuracy is {:.2f} %".format(100 * loss_and_acc_new_a_32[1]))
#----------------------------------------------------------------------------------------
...
filters = [28, 64, 64, 128, 128]
NNet_2 = get_net(input_shape, drop, dropRate, reg, filters)

AdamOpt = Adam(lr=learn_rate, decay=decay)

NNet_2.compile(optimizer=AdamOpt, metrics=['acc'], loss='categorical_crossentropy')

h_2 = NNet_2.fit(x=BaseX_train, y=BaseY_train,
                 batch_size=batch_size, epochs=epochs, verbose=1, validation_split=0,
                 validation_data=(BaseX_val, BaseY_val), shuffle=True)


results_2 = NNet_2.evaluate(X_test, Y_test)
